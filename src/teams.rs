...
pub const TEAMS: [Team; 33] = [
    Team::All,
    Team::NewJerseyDevils,
    Team::NewYorkIslanders,
    Team::NewYorkRangers,
    Team::PhiladelphiaFlyers,
    Team::PittsburghPenguins,
    Team::BostonBruins,
    Team::BuffaloSabres,
    Team::MontrealCanadiens,
    Team::OttawaSenators,
    Team::TorontoMapleLeafs,
    Team::CarolinaHurricanes,
    Team::FloridaPanthers,
    Team::TampaBayLightning,
    Team::WashingtonCapitals,
    Team::ChicagoBlackhawks,
    Team::DetroitRedWings,
    Team::NashvillePredators,
    Team::StLouisBlues,
    Team::CalgaryFlames,
    Team::ColoradoAvalanche,
    Team::EdmontonOilers,
    Team::VancouverCanucks,
    Team::AnaheimDucks,
    Team::DallasStars,
    Team::LosAngelesKings,
    Team::SanJoseSharks,
    Team::ColumbusBlueJackets,
    Team::MinnesotaWild,
    Team::WinnipegJets,
    Team::ArizonaCoyotes,
    Team::VegasGoldenKnights,
    Team::SeattleKraken,
];
